	...
	'targets': [
		{
			...
			'sources': [
				...
				'./<%=projectName%>/MainStoryboard_iPad.storyboard',
				'./<%=projectName%>/en.lproj/MainStoryboard_iPad.storyboard',
				'./<%=projectName%>/MainStoryboard_iPhone.storyboard',
			...
			'mac_bundle_resources': [
				...
				'./<%=projectName%>/Icon.png',
				'./<%=projectName%>/Icon@2x.png',
				'./<%=projectName%>/Icon-72.png',
				'./<%=projectName%>/Icon-72@2x.png',
