...
@param {string} basePath the path which the Hop will hang off of
@param {object} app the express app

@for Hop
@method apiHook
**/
Hop.apiHook=function(basePath,app){
	...
	for(var objectName in Hop.Objects){
		...
		for(var methodName in obj.methods){
			...
			Hop.log(method.method,method.path);	
			(function(obj,method){
	...
	Hop.apiURL = path.join(basePath,"api.js");
	...
	Hop.testURL=path.join(basePath,"test.js");
	...
	app.get(path.join(basePath,"/api.json"),function(req,res){
