...
/*
Hop.Object.prototype.toJSON=function(){
	var newObj = {};
	for(var i in this){
		if(/^_/.test(i){
...
Hop.Method = function(method,object,name,path){
...
Hop.Method.prototype.getPath=function(){
	return path.join(Hop.basePath,this.path.replace("#className",this._className.toLowerCase()));
}
