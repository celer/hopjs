...
/**
  ...
  *This will also test to insure the output is null*
  ...
  @method hasError 
**/
Hop.TestTask.errorContains={ pass:"An error was detected", fail: "An error was not detected" };
Hop.TestTask.prototype.hasError=function(value){
  var testFunc=function(input,err,output,value){ return (err!=null && output==null); }  
  this.test.push({ type:"hasError", value: value, testFunc:testFunc.toString() });
  return this;
}
